...
public class ChangeItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toCartButton = findViewById(R.id.toCartButtonC);
        toFavButton = findViewById(R.id.toFavoriteButtonC);
        plusButton = findViewById(R.id.plusButtonC);
        minusButton = findViewById(R.id.minusButtonC);

        showImage = findViewById(R.id.showItemImageViewC);

        showItemName = findViewById(R.id.showItemNameTextViewC);
        showPrice = findViewById(R.id.showItemPriceTextViewC);
        showQuantity = findViewById(R.id.showQuantityTextViewC);

        enterQuantity = findViewById(R.id.enterQuantityEditTextC);
    ...
    public void buy(View view){
        if(isInteger(enterQuantity.getText().toString())){
            ...
            //Toast toast = Toast.makeText(getApplicationContext(), "Zu dem Warenkorb hinzugefugt", Toast.LENGTH_SHORT);
        }
        else{
        ...
        newRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Cart").child(toShow.getNameGerman()).exists())){
                    ...
                    newRef.child("Cart").child(toShow.getNameGerman()).updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(ChangeItemActivity.this, "Die Ware wurde in den Warenkorb hinzugefugt", Toast.LENGTH_SHORT).show();
                            }

                            else{
                                Toast.makeText(ChangeItemActivity.this, "Bitte noch mals versuchen!!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    Toast.makeText(ChangeItemActivity.this, "Quantitat wurde verandert", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Favs").child(toShow.getNameGerman()).exists())){
                    ...
                    newRef.child("Favs").child(toShow.getNameGerman()).updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(ChangeItemActivity.this, "Die Ware wurde in den Favoriten hinzugefugt", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    Toast.makeText(ChangeItemActivity.this, "Die Ware ist schon in den Favoriten",Toast.LENGTH_SHORT ).show();
                }
            }
